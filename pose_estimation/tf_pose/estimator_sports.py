...
# import tensorflow.contrib.tensorrt as trt # tf v1
...
class TfPoseEstimator:
    ...
    def __init__(self, graph_path, target_size=(320, 240), tf_config=None, trt_bool=False):
        ...
        tf.compat.v1.disable_eager_execution()  ## tf2:Not run under eager mode
    ...
    def get_flops(self):
        flops = tf.compat.v1.profiler.profile(self.graph,
    ...
    def inference(self, npimg, resize_to_default=True, upsample_size=1.0):
        ...
        # self.heatMat = heatMat_up
        # self.pafMat = pafMat_up
        ...
        return peaks, heatMat_up[0], pafMat_up[0]
